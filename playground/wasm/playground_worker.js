...
const PlaygroundEngineFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_playgroundengine_free(ptr >>> 0, 1));
...
export class PlaygroundEngine {
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        PlaygroundEngineFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_playgroundengine_free(ptr, 0);
    }
    constructor() {
        const ret = wasm.playgroundengine_new();
        this.__wbg_ptr = ret >>> 0;
        PlaygroundEngineFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
    ...
    evaluate(source) {
        ...
        const ret = wasm.playgroundengine_evaluate(this.__wbg_ptr, ptr0, len0);
        if (ret[2]) {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('playground_worker_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
